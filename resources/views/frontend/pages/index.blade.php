...
<div class=" pos_home_section">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="single_product">
                                                        <div class="product_thumb">
                                                           <a href="{{route('product_detail',['id' => $product->id])}}"><img src="img\product\product1.jpg" alt=""></a> 
                                                           <div class="img_icone">
                                                        ...
                                                        <div class="product_info">
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <a type="submit" href="#" data-toggle="modal" class="view_detail" data-action="{{route('view_data')}}" data-id="{{$product->id}}" data-target="#modal_box" title="Quick view">View Detail</a>
                      ...
                      <div class="modal fade detail_popup" id="modal_box" tabindex="-1" role="dialog" aria-hidden="true">
                      </div>
                      <script src="js\ajax-viewdetail.js"></script>
@endsection