                                                        ...
                                                        <div class="col-lg-4 col-md-6">
                                                            <div class="single_product">
                                                                <div class="product_thumb">
                                                                   <a href="{{route('product_detail',['id' => $data->id])}}"><img src="img\product\product1.jpg" alt=""></a> 
                                                                   <div class="img_icone">
                                                                ...
                                                                <div class="product_content">
                                                                    ...
                                                                    <h3 class="product_title"><a href="{{route('product_detail',['id' => $data->id])}}">{{$data->name_product}}</a></h3>
                                                                </div>
                                                    ...
                                                    <div class="product_list_item mb-35">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-lg-4 col-md-6 col-sm-6">
                                                                <div class="product_thumb">
                                                                   <a href="{{route('product_detail',['id' => $data->id])}}"><img src="img\product\product2.jpg" alt=""></a> 
                                                                   <div class="hot_img">
                                                                ...
                                                                <div class="list_product_content">
                                                                   <div class="product_ratting">
                                                                    ...
                                                                    <div class="list_title">
                                                                        <h3><a href="{{route('product_detail',['id' => $data->id])}}">{{$data->name_product}}</a></h3>
                                                                    </div>
                                        ...
                                        <div class="sidebar_widget special">
                                            ...
                                            <div class="special_product_inner mb-20">
                                                <div class="special_p_thumb">
                                                    <a href="#"><img src="img\cart\cart3.jpg" alt=""></a>
                                                </div>
                                            ...
                                            <div class="special_product_inner">
                                                <div class="special_p_thumb">
                                                    <a href="#"><img src="img\cart\cart18.jpg" alt=""></a>
                                                </div>
                                                <div class="small_p_desc">
                                                    <div class="product_ratting">
                                                       <ul>
